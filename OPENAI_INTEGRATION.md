# OpenAI Integration Guide for Relaxess

## Overview

Relaxess uses OpenAI's `gpt-4o-mini` model to provide context-aware, emotionally supportive AI responses. The system is optimized for low token usage while maintaining high-quality, calm, and therapeutic responses.
...
6. **Fine-tuning**: Create custom model trained on Relaxess data
