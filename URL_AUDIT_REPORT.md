...
This audit identifies **all locations** in the Relaxess project where the following URLs will eventually be required:

- **Privacy Policy URL** (e.g., `https://relaxess.com/privacy`)
- **Terms of Use URL** (e.g., `https://relaxess.com/terms`)
- **Support URL** (e.g., `https://relaxess.com/support`)
- **Contact Email** (e.g., `support@relaxess.com`)
...
|------|------|---------------|------------------------|--------------|----|
| `app.config.ts` | 31 | `appName: "{{project_title}}"` | `appName: "Relaxess"` | Both | ✓ Placeholder |
| `app.config.ts` | 32 | `appSlug: "relaxess"` | Keep as-is | Both | ✓ Fixed |
...
const env = {
  // ... existing config ...
  privacyPolicyUrl: "https://relaxess.com/privacy",
  termsOfUseUrl: "https://relaxess.com/terms",
  supportUrl: "https://relaxess.com/support",
  supportEmail: "support@relaxess.com",
};
```
...
| File | Line | Current Value | Recommended Replacement | Required For | Status |
|------|------|---------------|------------------------|--------------|----|
| `PRIVACY_POLICY.md` | 266 | `[support@relaxess.com]` | `support@relaxess.com` | Both | ✓ Placeholder |
| `PRIVACY_POLICY.md` | 267 | `[Company Address]` | Your company address | Both | ✓ Placeholder |
| `PRIVACY_POLICY.md` | 268 | `[www.relaxess.com]` | Your website URL | Both | ✓ Placeholder |
| `PRIVACY_POLICY.md` | 224 | `[support@relaxess.com]` | `support@relaxess.com` | Both | ✓ Placeholder |
| `PRIVACY_POLICY.md` | 234 | `[support@relaxess.com]` | `support@relaxess.com` | Both | ✓ Placeholder |
| `PRIVACY_POLICY.md` | 242 | `[support@relaxess.com]` | `support@relaxess.com` | Both | ✓ Placeholder |
...
| File | Line | Current Value | Recommended Replacement | Required For | Status |
|------|------|---------------|------------------------|--------------|----|
| `TERMS_OF_USE.md` | 272 | `https://[your-domain]/privacy` | `https://relaxess.com/privacy` | Both | ✓ Placeholder |
| `TERMS_OF_USE.md` | 350 | `[support@relaxess.com]` | `support@relaxess.com` | Both | ✓ Placeholder |
| `TERMS_OF_USE.md` | 378 | `[support@relaxess.com]` | `support@relaxess.com` | Both | ✓ Placeholder |
| `TERMS_OF_USE.md` | 393 | `[support@relaxess.com]` | `support@relaxess.com` | Both | ✓ Placeholder |
| `TERMS_OF_USE.md` | 405 | `[support@relaxess.com]` | `support@relaxess.com` | Both | ✓ Placeholder |
...
| `TERMS_OF_USE.md` | 377 | `[support@relaxess.com]` | `support@relaxess.com` | Both | ✓ Placeholder |
| `TERMS_OF_USE.md` | 379 | `[www.relaxess.com]` | Your website URL | Both | ✓ Placeholder |
...
| Service | URL | Current Value | Status | Required For |
|---------|-----|---------------|--------|--------------|
| AWS S3 Bucket | `https://relaxess-audio.s3.us-east-1.amazonaws.com/` | Hardcoded in lib/_core/audio-manager.ts | ✓ Fixed | Both |
...
|-------|---------------|-----------------|--------|
| Privacy Policy URL | Not set | `https://relaxess.com/privacy` | ✗ Missing |
| Terms of Use URL | Not set | `https://relaxess.com/terms` | ✗ Missing |
| Support Email | Not set | `support@relaxess.com` | ✗ Missing |
| Support URL | Not set | `https://relaxess.com/support` | ✗ Missing |
...
|-------|---------------|-----------------|--------|
| Privacy Policy URL | Not set | `https://relaxess.com/privacy` | ✗ Missing |
| Terms of Service URL | Not set | `https://relaxess.com/terms` | ✗ Missing |
| Support Email | Not set | `support@relaxess.com` | ✗ Missing |
...
|----------|-------------|-------------------|--------------|---------|--------|
| Privacy Policy | `[www.relaxess.com]/privacy` | `https://relaxess.com/privacy` | Both | Website | ✗ Needed |
| Terms of Use | `[www.relaxess.com]/terms` | `https://relaxess.com/terms` | Both | Website | ✗ Needed |
| Support | `[www.relaxess.com]/support` | `https://relaxess.com/support` | Optional | Website | ✗ Needed |
| Support Email | `[support@relaxess.com]` | `support@relaxess.com` | Both | Email | ✗ Needed |
| Company Website | `[www.relaxess.com]` | `https://relaxess.com` | Optional | Website | ✗ Needed |
...
- [ ] Register domain (e.g., relaxess.com)
- [ ] Set up HTTPS certificate
- [ ] Create website with legal pages
- [ ] Host Privacy Policy at `https://relaxess.com/privacy`
- [ ] Host Terms of Use at `https://relaxess.com/terms`
- [ ] Create support page at `https://relaxess.com/support`
- [ ] Set up support email (support@relaxess.com)

### Phase 2: Update Legal Documents
- [ ] Replace `[Company Name]` in PRIVACY_POLICY.md
- [ ] Replace `[Company Name]` in TERMS_OF_USE.md
- [ ] Replace `[support@relaxess.com]` in both documents
- [ ] Replace `[Company Address]` in both documents
- [ ] Replace `[www.relaxess.com]` in both documents
