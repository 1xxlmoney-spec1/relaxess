...
This guide explains how to update Relaxess audio files **without any coding knowledge**.
...
"relaxm1": {
  "name": "Relaxing Music",
  "s3Url": "https://relaxess-audio.s3.amazonaws.com/relaxm1.mp3",
  ...
}
```
...
1. Create S3 bucket: `relaxess-audio`
2. Upload MP3 file
...
"relaxm1": {
  ...
  "isPremium": false,
  "s3Url": "https://relaxess-audio.s3.amazonaws.com/relaxm1.mp3",
  "firebaseUrl": "gs://relaxess.appspot.com/audio/relaxm1.mp3",
  "duration": 900000,
  "size": 7340032,
