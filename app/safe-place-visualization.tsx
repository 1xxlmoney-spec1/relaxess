    ...
    <Animated.View style={animatedContentStyle} className="flex-1 justify-center items-center gap-6 px-6">
      ...
      >
        <View
          ...
          className="py-4 px-8 rounded-3xl items-center border shadow-lg"
        >
            ...
            {environments.map((env) => (
              ...
              >
                <View
                  ...
                  className="mb-4 rounded-2xl overflow-hidden border shadow-md"
                >
                  <Image
                  ...
                  <View className="p-4">
                    ...
                    <Text className={theme === "dark" ? "text-white text-opacity-75 text-sm" : "text-muted text-sm"}>{env.description}</Text>
                  </View>
                </View>
              </Pressable>
          ))}
    ...
    return (
      <Animated.View style={animatedContentStyle} className="flex-1 justify-center items-center px-6 gap-6">
        ...
        <View
          ...
          className="rounded-2xl p-6 gap-4 border shadow-lg"
        >
        ...
        >
          <View
            ...
            className="py-4 px-8 rounded-3xl items-center border shadow-lg"
          >
            <Text className="text-lg font-bold text-foreground">{t('safePlace.continue')}</Text>
          </View>
        </Pressable>
      </Animated.View>
    );
      ...
      <View className="flex-row gap-3 w-full">
        ...
        >
          <View
            ...
            className="py-4 px-6 rounded-3xl items-center border shadow-lg"
          >
            <Text className="text-lg font-bold text-foreground">{t('safePlace.repeat')}</Text>
          </View>
        </Pressable>
        <Pressable
          onPress={handleDone}
